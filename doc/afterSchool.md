...
## PART III - 4회차
이 스터디는 왜 이것저것 하나 했는데 bio 범주가 엄청 넓네요. 오늘은 최적화 기법, Anealing, ga. 마치 손고리즘에 와있는 기분이였네여.
Anealing 은 알고 있었는데 왠 Anealing 인가 봤더니 방법론인데 금속에서 사례에서 빌려 왔고 알고리즘이네요 ga도 마찬가지고,
python 은 그냥 도구이고. 알고리즘을 더하여bio 문제들을 풀어내고 있네요.
 성호님은 Traveling Salesperson Problem 문제 풀이를 두가지 기법으로 풀어내 주셨습니다.  동진님은 선형대수 요약 해주셨습니다.
성호님, 동진님 두 거인의 어깨를 잠시 빌려 최적화 기법과 선형대수를 엿볼 수 있었습니다.
성호님은 멋진 책들도 나누어 주셨습니다. 저도 한권 받았는데 "생체모방" 전체를 쑥 훑어 봤는데
자연에 답이 있네요. bio 참 멋진 분야입니다.
by 곽두환_141203
