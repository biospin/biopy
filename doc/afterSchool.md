...
## PART III - 4회차
이 스터디는 왜 이것저것 하나 했는데 bio 범주가 엄청 넓네요. 오늘은 최적화 기법, Anealing, ga.
마치 손고리즘에 와있는 기분이였네여. Anealing 은 알고 있었는데 왠 Anealing 인가 봤더니 방법론인데
금속에서 사례에서 빌려 왔고 알고리즘이네요 ga도 마찬가지고, python 은 그냥 도구이고. 알고리즘을 더하여bio 문제들을 풀어내고 있네요.
