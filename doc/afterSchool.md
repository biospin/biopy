...
바로 쉡모양이 바귀는거 봐서 worker쪽에 자원할당 받은 상태로 login 하는 것으로 보입니다.
...
서버 구성을 쉽게 만들수 있다. 이미지로 담아두면 확장도 싶습니다.
관리도 쉽고, 자원을 효율적으로 사용할 수 있습니다.
구성을 마련하는 것도 일이 텐다. 잘 되어 있는 셋이네요.
...
자제 서버 없이도 적은 비용으로 서버를 효율적으로 사용할 수 있는 좋은 세상입니다.
쉘명령어는 역시 강력하네요 명령어에 옵션 몇 개 주고,
별다른 로직없이 명령어 나열 하는것으로 원하는 분석이 끝났습니다.

bio 작업을 빌어 서버 구성 하나를 잘 구경했습니다.
좋은 구경 시켜주신 노규형님께 감사드립니다
by 곽두환_141207
