...
## TFT 설치
pi@raspberrypi ~ $ git clone https://github.com/rasplay/RPiHY28bShield
pi@raspberrypi ~ $ cd RPiHY28bShield
pi@raspberrypi ~/RPiHY28bShield $ sh setup.sh hy28b
pi@raspberrypi ~/RPiHY28bShield $ sudo reboot
